...
//       // Assuming your backend returns posts as an array of objects
//       // each with `id`, `user_id`, `content`, and `timestamp`.
...
//     async (postContent) => {
//       try {
//         // Sends post content to your backend's /api/posts endpoint
...
//       try {
//         // Sends comment data to your backend's /api/comments endpoint
//         // `userId` here is for frontend display if backend doesn't return it
...
//     try {
//       const response = await axiosInstance.get(`/comments?postId=${post.id}`);
...
//     try {
//       const response = await axiosInstance.get("/posts");
//       // CORRECTED: Safely access the posts array.
//       // Assuming your backend might return { data: [...] } or just [...]
//       // If your backend uses a different key (e.g., { posts: [...] }), adjust 'response.data.data' accordingly.
