...
//       if (
//         clientId === "cc5f4c9fbf304384a5ae6c12a7751f61" ||
//         clientSecret === "608ee54cd2e348b2bfd30173e47266ae"
//       ) {
//         console.warn(
...
// This component fetches and displays upcoming music releases from MusicBrainz and Spotify.
function UpcomingMusic() {
  const [releases, setReleases] = useState([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
